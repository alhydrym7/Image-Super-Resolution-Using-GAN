...
def test_model(input_high_res, model, number_of_images, output_dir):
    x_test_lr, x_test_hr = Utils.load_test_data_for_model(input_high_res, 'png', number_of_images)
    Utils.plot_test_generated_images_for_model(output_dir, model, x_test_hr, x_test_lr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ihr', '--input_high_res', action='store', dest='input_high_res', default='./data/',
    ...
    if values.test_type == 'test_model':
        test_model(values.input_high_res, model, values.number_of_images, values.output_dir)
